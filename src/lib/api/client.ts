...
export const api = {
  ...
  async libraryStorageStats(): Promise<LibraryStorageStats> {
    if (shouldUseRemoteApi()) {
      return remoteFetch<LibraryStorageStats>("/api/library/storage-stats");
    }
    return localInvoke<LibraryStorageStats>("library_storage_stats");
  },
